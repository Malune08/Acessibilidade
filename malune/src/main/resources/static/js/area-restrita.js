            ...
            <tr>
                <td>
                    <div class="recent-order-info">
                        <span class="recent-order-name">${escapeHtml(order.nomeProduto || 'Produto não informado')}</span>
                        <span class="recent-order-date">${escapeHtml(formatDate(order.dataPedido))}</span>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td>
                    <div class="product-actions">
                        <button class="action-icon action-edit js-edit-product" data-id="${product.id}" type="button" aria-label="Editar ${escapeHtml(product.nome)}" title="Editar produto">
                        ...
                        <button class="action-icon action-delete js-delete-product" data-id="${product.id}" type="button" aria-label="Excluir ${escapeHtml(product.nome)}" title="Excluir produto">
